...
CollectiveThrustMapping::CollectiveThrustMapping() :
    thrust_map_a_(0.0), thrust_map_b_(0.0), thrust_map_c_(0.0), perform_thrust_voltage_compensation_(false), thrust_ratio_voltage_map_a_(
        0.0), thrust_ratio_voltage_map_b_(0.0), n_lipo_cells_(0)
{
}
...
CollectiveThrustMapping::CollectiveThrustMapping(const double thrust_map_a, const double thrust_map_b,
    ...
    thrust_map_a_(thrust_map_a), thrust_map_b_(thrust_map_b), thrust_map_c_(thrust_map_c), perform_thrust_voltage_compensation_(
        perform_thrust_voltage_compensation), thrust_ratio_voltage_map_a_(thrust_ratio_voltage_map_a), thrust_ratio_voltage_map_b_(
        thrust_ratio_voltage_map_b), n_lipo_cells_(n_lipo_cells)
{
}
...
uint16_t CollectiveThrustMapping::inverseThrustMapping(const double thrust, const double battery_voltage) const
{
  ...
  if (perform_thrust_voltage_compensation_)
  {
    ...
    {
      const double thrust_cmd_voltage_ratio = thrust_ratio_voltage_map_a_ * battery_voltage
