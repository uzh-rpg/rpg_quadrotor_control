...
double lowpass(const double filterin, const double input, const double fc, const double dt);
Eigen::Vector3d lowpass(const Eigen::Vector3d& filterin, const Eigen::Vector3d& input, const double alpha);
Eigen::Vector3d lowpass(const Eigen::Vector3d& filterin, const Eigen::Vector3d& input, const double fc,
                        const double dt);
...
Eigen::Affine3d lowpass(const Eigen::Affine3d& filterin, const Eigen::Affine3d& input, const double fc,
                        const double dt);
